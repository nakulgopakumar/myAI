...
export const CHAT_HEADER: string = `Your AI partner for smarter venture Investing`;
export const MESSAGE_PLACEHOLDER: string = `[MESSAGE PLACEHOLDER]`;
export const FOOTER_MESSAGE: string = `Awesome Entrepreneurs. Real results`;
export const CLEAR_BUTTON_TEXT: string = `clear History`;
export const PAGE_TITLE: string = `Dealora welcomes you!`;
